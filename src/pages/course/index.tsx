                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 max-w-8xl mx-auto">
                            ...
                            <div className="order-last xl:order-first flex flex-col gap-y-3 h-full py-10">
                                ...
                                <div className="flex flex-col xl:text-white">
                                    <h1 className="title text-[3.5rem] font-bold  max-w-lg">Capacitação em Leitura Cientiífica</h1>
                                </div>

                                <div className="bg-white shadow-xl rounded-lg flex flex-col py-5 gap-y-2 items-center">
                                    <span className="text-[1rem] font-medium text-primary_black">Parceiros do Curso</span>
                                    <div className="grid grid-cols-2 gap-x-3 mt-3">
                                        <span className="pr-4 border-r-2">
                                            <StaticImage src="../../images/galen_logo.svg" objectFit="contain" width={130} alt="Galen Academy Logo" />
                                        </span>
                                        <span>
                                            <StaticImage src="../../images/brci_logo.svg" objectFit="contain" width={93} alt="BRCI Logo" />
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col mt-10">
                                    <div className="flex flex-col gap-y-3 pb-5">
                                        ...
                                        <a href="#" className="hover:opacity-70 mt-5 w-full py-4 flex flex-row justify-center rounded-full text-white text-md bg-[#4242FF16]">
                                            <span className="text-primary_blue font-bold ">Garantir minha vaga</span>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <form className="bg-white overflow-hidden shadow-xl rounded-xl h-full" action="#">
                                        <div className="w-full flex gap-y-3 items-center flex-col bg-neutral-100 px-10 py-6">
                                            <span className="text-sm font-[500] text-neutral-700 [&>strong]:text-xl [&>strong]:text-neutral-950">
                                                <strong>R$950,00</strong> no cartão ou <strong>R$902,50</strong> no pix à vista
                                            </span>
                                        ...
                                        <div className="flex flex-col px-10 py-3">
                                            ...
                                            <span className="text-sm font-normal text-neutral-600">
                                                Complete com seus dados para garantir sua vaga na formação de <strong>Capacitação em Leitura Cientiífica</strong>
                                            </span>
                                        </div>
                                        <div className="px-10 flex flex-col gap-y-3">
                                            <input type="text" className="w-full border-b-2 text-neutral-400 focus:text-neutral-900 font-normal  py-2 px-2 focus:outline-none focus:border-b-2 focus:border-neutral-600" placeholder='Como gostaria de ser chamado?' />
                                            <input type="text" className="w-full border-b-2 text-neutral-400 focus:text-neutral-900 font-normal  py-2 px-2 focus:outline-none focus:border-b-2 focus:border-neutral-600" placeholder='Qual seu melhor email?' />
                                            <input type="text" className="w-full border-b-2  text-neutral-400 focus:text-neutral-900 font-normal  py-2 px-2 focus:outline-none focus:border-b-2 focus:border-neutral-600" placeholder='+55 | Insira seu celular' />
                                            <select className="w-full text-neutral-400 font-normal border-b-2 focus:text-neutral-900 py-2 px-2 focus:outline-none focus:border-b-2 focus:border-neutral-600">
                                                <option value="" selected>Qual sua profissão?</option>
                                            </select>
                                            ...
                                            <select className="w-full text-neutral-400 border-b-2 py-2 px-2 focus:outline-none focus:border-b-2 focus:border-neutral-600">
                                                <option value="" selected>Qual sua especialidade?</option>
                                            </select>
                                            <div className="flex flex-row gap-x-2 mt-3">
                                                <label className="text-neutral-500 text-[1rem] control control-checkbox">
                                                    Receber novidades da Galen
                                                    <input type="checkbox" id="optin_newsletter" name="optin_newsletter" />
                                            ...
                                            <div className='pb-10 flex flex-col gap-y-5'>
                                                <span className="text-sm text-neutral-500">
                                                    Ao informar meus dados, estou ciente das diretrizes da <a href="#" className="text-primary_blue underline">Política de Privacidade</a>.
                                                </span>
